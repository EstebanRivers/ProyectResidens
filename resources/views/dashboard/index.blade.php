...
<div class="dashboard-sections">
    ...
    <div id="mi-informacion" class="section-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Datos personales y estadísticas</p>
        </div>
    ...
    <div id="cursos" class="section-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Gestión de cursos y materias</p>
        </div>
    ...
    <div id="facturacion" class="section-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Información de pagos y facturación</p>
        </div>
    ...
    <div id="control-administrativo" class="section-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Herramientas de administración del sistema</p>
        </div>
    ...
    <div id="ajustes" class="section-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Configuración de perfil y preferencias</p>
        </div>
